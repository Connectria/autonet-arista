...
@pytest.mark.parametrize('test_vxlan, expected_imports, expected_exports', [
    ...
    (an_vxlan.VXLAN(
        ...
        bound_object_id=71),
     ['route-target import 65002:70005', 'route-target import 65002:70002'],
    ...
    (an_vxlan.VXLAN(
     ...
     ['route-target import 65002:70005', 'route-target import 65002:70001'],
     ['route-target export 65002:70005', 'route-target export 65002:70001']),
    (an_vxlan.VXLAN(
        id=20000, layer=3, import_targets=['auto'], export_targets=['auto'],
        route_distinguisher='198.18.0.101:4094', bound_object_id='red'),
    ...
    (an_vxlan.VXLAN(
     ...
     ['route-target import 65002:20001', 'route-target import 65002:20010',
      'route-target import 65000:50'],
     ['route-target export 65002:20001', 'route-target export 65002:20010']),
    (an_vxlan.VXLAN(
        id=20001, layer=3, import_targets=['auto', '65000:50'],
        export_targets=['auto', '65002:20010'],
        route_distinguisher='auto', bound_object_id='blue'),
     ['route-target import 65000:50', 'route-target import 65002:20001'],
     ['route-target export 65002:20010', 'route-target export 65002:20001'])
])
def test_generate_rt_commands(test_vxlan, expected_imports, expected_exports):
    assert vxlan_task.generate_rt_commands(
...
@pytest.mark.parametrize('test_vxlan, expected', [
    ...
    (an_vxlan.VXLAN(
     ...
     [
         ...
         'route-target import 65002:20010',
         'route-target import 65000:50',
         'route-target export 65002:20001',
         'route-target export 65002:20010'
     ]),
    (an_vxlan.VXLAN(
        id=20001, layer=3, import_targets=['auto', '65000:50'],
        export_targets=['auto', '65002:20010'],
